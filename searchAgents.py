...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # State -> tuple of (position, corners_visited)
        # corners_visited -> tuple of booleans
    ...
    def getSuccessors(self, state: Any):
        ...
        successors = []
        x, y = state[0] # current pos
        corners_visited = state[1]  #visited corners
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                #list to modify the visited corners
                ...
                if next_pos in self.corners:
                    ...
                    corners_visited_list[corner_index] = True
                

                #create the successor state
                next_state = (next_pos, tuple(corners_visited_list))
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    # ypologismos manhattan distance gia ka8e unvisited corner
    total_distance = 0
    current = current_position
    
    # oso yparxoun unvisited corners
    while unvisited_corners:
        ...
        #update current position to the corner we just visited
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    #calc distances to all food dots
    distances_to_food = []

    for food in food_list:
        # Use maze distance instead of Manhattan distance
        distance = mazeDistance(position, food, problem.startingGameState)
        distances_to_food.append(distance)
    
    # epistrefei ti megisti apostasi apo opoiadipote food dot
    # ayto stekei ka8ws prepei na taksidepsoume to poly mexri to makrynotero food dot
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state: Tuple[int, int]):
        ...
        x, y = state
        "*** YOUR CODE HERE ***"
        #return true if theres food at this position
